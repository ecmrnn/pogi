<?php 
    ...
    $base_url = $protocol . $_SERVER['HTTP_HOST'] . '/activities/FINALS/PROJECT/guest/';
?>
...
<nav>
    ...
    <div class="mt-5 space-y-1">
        <a class="rounded-md block font-semibold text-sm transition-all ease-in-out flex items-center gap-3 group" href="<?php echo $base_url; ?>dashboard.php">
        ...
        <a class="rounded-md block font-semibold text-sm transition-all ease-in-out flex items-center gap-3 group" href="<?php echo $base_url; ?>reservation.php">
            ...
            <span class="group-hover:text-blue-500 transition-all ease-in-out <?php echo in_array('reservation.php', $path) || in_array('reservation', $path) ? 'text-blue-500' : '';?>">Reservations</span>
        </a>
        <a class="rounded-md block font-semibold text-sm transition-all ease-in-out flex items-center gap-3 group" href="<?php echo $base_url; ?>settings.php">
